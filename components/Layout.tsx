  ...
  return (
    <>
      ...
      >
        ...
        {templateData.pieChart && (
          <div>
            <div class="text-lg font-bold text-slate-700 dark:text-white justify-center content-center">
              {templateData.pieChart.title}
            </div>
            ...
            <ChartIsland
              ...
              options={{}}
              data={{
                labels: templateData.pieChart.labels,
                datasets: [
                  {
                    label: templateData.pieChart.title,
                    data: templateData.pieChart.data,
          ...
          {templateData.lineChart && (
            <>
              ...
              <ChartIsland
                ...
                data={{
                  labels: templateData.lineChart.labels,
                  datasets: [
                    {
                      label: templateData.lineChart.title,
                      data: templateData.lineChart.data,
                      borderColor: ChartColors.Red,
                      backgroundColor: transparentize(ChartColors.Red, 0.5),
                      borderWidth: 1,
                    },
